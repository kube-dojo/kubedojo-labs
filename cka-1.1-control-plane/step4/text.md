...
Check whether the scheduler and controller-manager pods are running, and save their status to `$HOME/cp-health.txt`. Include the pod name and status for each.
