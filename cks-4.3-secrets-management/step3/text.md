...
4. Verify that `app-sa` can get a specific secret but cannot list all secrets. Save the verification to `"$HOME"/secret-rbac-test.txt`.
5. Create `"$HOME"/secrets-best-practices.txt` with at least 5 secrets management best practices.
