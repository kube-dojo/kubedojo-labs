...
kubectl create deployment app-v1 --image=nginx:1.25 -n practice
kubectl create deployment app-v2 --image=httpd:2.4 -n practice
kubectl create deployment blog --image=nginx:1.25 -n practice

kubectl expose deployment app-v1 -n practice --port=80
kubectl expose deployment app-v2 -n practice --port=80
kubectl expose deployment blog -n practice --port=80
