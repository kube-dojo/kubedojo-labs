...
1. Create a script `$HOME/immutability-audit.sh` that:
...
2. Run the script and save output to `$HOME/immutability-report.txt`.
3. Create `$HOME/immutability-best-practices.txt` with at least 5 best practices for immutable infrastructure.
