...
4. Verify the ServiceAccount can list pods: `kubectl auth can-i list pods -n exam-practice --as=system:serviceaccount:exam-practice:exam-sa` and save the result to `"$HOME"/rbac-check.txt`.
