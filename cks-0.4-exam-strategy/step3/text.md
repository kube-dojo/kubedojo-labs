...
2. Create a file `"$HOME"/exam-notes.txt` with your exam strategy notes — list 3 quick-win tasks, 3 medium tasks, and 3 complex tasks (one per line, 9 lines total).
