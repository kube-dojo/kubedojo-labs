...
- Mount ConfigMaps as volumes inside pods
- Create and mount Secrets
- Inject ConfigMap and Secret values as environment variables

### Before You Start

- Read the [module page](https://kube-dojo.github.io/k8s/cka/part2-workloads-scheduling/module-2.7-configmaps-secrets/) for theory
